...
const About = ({ navigation }) => (
  <Container>
    ...
    <ScreenText>
      Moventu is an app born from the necessity to encourage
      users to GO OUT, making them feel the motivation to explore and discover
      new locations around them.
      {"\n"}
      {"\n"}
